...
# db/ is the production tree and lives at the root; everything it reads from but
# does not own -- the PAK reader, the TIDBI export, alfgeir's site data -- stays
# in test/ beside it.
TEST = os.path.join(ROOT, 'test')
TL2 = os.path.join(TEST, 'tl2')
OUT = os.path.join(HERE, 'out')
TIDBI = os.path.join(TEST, 'tidbi')
ICON_DIR = os.path.join(TIDBI, 'TIDBI_original', 'icons')
ALFGEIR = os.path.join(TEST, 'alfgeir_db_website', 'tl2-master', 'data', 'All', 'EN.json')
